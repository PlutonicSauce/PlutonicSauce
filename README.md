...
- **[Groundtruth](#)** — tamper-evident used-vehicle inspection tool, Next.js 15 + SQLite + local OCR
- **[Chronicle](https://github.com/PlutonicSauce/chronicle)** — persistent memory for AI coding agents, CockroachDB + AWS Lambda
- **[Reel Ledger](https://github.com/PlutonicSauce/reel-ledger)** — agentic media rights compliance verifier
